...
const products = {
  "Ham Radio Resources": [
    ...
    },
    {
      name: "Repeaters",
      description:
        "PARC has a vast netwok of repeaters located in the province. Learn more about our owned repeaters.",
      href: "#",
      icon: LuRadioTower,
    },
    {
      name: "EchoLink & IRLP",
      description:
        "We use EchoLink & IRLP with all our repeaters to create our wide repeater System.",
      href: "#",
      icon: IoMdWifi,
    },
    {
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          {Object.keys(products).map((category) => (
            <Popover className="relative" key={category}>
              ...
              <PopoverPanel
                transition
                className="absolute left-[50%] -translate-x-1/2 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5 transition data-[closed]:translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
              >
                <div className="p-4">
