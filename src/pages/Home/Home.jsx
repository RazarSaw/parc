...
export default function Home() {
  ...
  return (
    <main className="bg-neutral-800">
      <div className="grid xl:grid-cols-[1fr_auto] grid-cols-1 lg:gap-8 container mx-auto py-16">
        <div className="p-4 text-white flex flex-col gap-20">
          <section className="flex flex-col gap-8">
            <h2>Connecting Communities for Public Service, CANWARN and FUN</h2>
            <p>
              <img
              ...
              the 'Canora Amateur Radio Club', in February 2002. We started with
              a local repeater, and soon had IRLP or V.O.I.P. Communication
              installed and linked, which expanded our range of communication to
              all around the world. Once more operators knew of our local
              accomplishments they soon joined our club. In January 2004, we
              started with the addition of EchoLink to our existing IRLP Node,
              which also improved our coverage to include communication via
              computer keyboard.
            </p>
            <p>
              Our goals as a club seem to be changing faster than ever and over
              the next couple of years more amateur's joined the club, and in
              April 2006, we changed our club name to: The Parkland Amateur
          ...
          <section className="flex flex-col gap-8">
            ...
            <p>
              ...
              equipment and repeater network, more information can be viewed on
              the following link:
            ...
            <section className="grid grid-cols-[repeat(auto-fit,_minmax(250px,1fr))] gap-8">
              {repeaters.map((repeater) => {
                return (
                  <article className="bg-neutral-700 rounded-[8px] p-4" key={repeater.callsign}>
