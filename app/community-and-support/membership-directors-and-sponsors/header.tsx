export default function Header() {
  return (
    <header
      className={`bg-[url('/parc/images/headers/ve5pwo-pobetkoff.jpg')] bg-no-repeat bg-fixed bg-cover bg-bottom min-h-[40vh] grid grid-cols-1 grid-rows-1 justify-center bg-black/75 bg-blend-multiply`}
    >
